...
<div id="list-car" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="seatsNb" title="${message(code: 'car.seatsNb.label', default: 'Seats Nb')}"/>

            <g:sortableColumn property="vehicleName"
                              title="${message(code: 'car.vehicleName.label', default: 'Vehicle Name')}"/>
        ...
        <g:each in="${carInstanceList}" status="i" var="carInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${carInstance.id}">${fieldValue(bean: carInstance, field: "seatsNb")}</g:link></td>

                <td>${fieldValue(bean: carInstance, field: "vehicleName")}</td>
