    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="seatsNb"
                              title="${message(code: 'vehicle.seatsNb.label', default: 'Seats Nb')}"/>

            <g:sortableColumn property="vehicleName"
                              title="${message(code: 'vehicle.vehicleName.label', default: 'Vehicle Name')}"/>
        ...
        <g:each in="${vehicleInstanceList}" status="i" var="vehicleInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${vehicleInstance.id}">${fieldValue(bean: vehicleInstance, field: "seatsNb")}</g:link></td>

                <td>${fieldValue(bean: vehicleInstance, field: "vehicleName")}</td>
